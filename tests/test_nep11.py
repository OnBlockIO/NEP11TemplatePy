...
class TestNEP11(boatestcase.BoaTestCase):
    DECIMALS = 0
    OWNER_BALANCE = 0
    TOTAL_SUPPLY = 0
    ...
    async def asyncSetupClass(cls) -> None:
        ...
        await cls.set_up_contract('..', 'contracts/NEP11', 'NEP11-Template.py', signing_account=cls.owner)
    ...
    def test_compile(self):
        path = self.get_contract_path('..', 'contracts/NEP11', 'NEP11-Template.py')
